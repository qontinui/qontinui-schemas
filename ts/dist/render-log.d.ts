 ...
 */
export type RenderLogTrigger = "mount" | "navigation" | "mutation" | "data_update" | "prop_change" | "manual" | "interval";
/**
 ...
 */
export declare function isComponentRenderLog(entry: RenderLogEntry): entry is ComponentRenderLogEntry;
/**
 * Check if a render log entry is a DOM snapshot log.
 */
export declare function isDomSnapshotRenderLog(entry: RenderLogEntry): entry is DomSnapshotRenderLogEntry;
//# sourceMappingURL=render-log.d.ts.map