import { T as TaskRunFindingActionType, a as TaskRunFindingCategory, b as TaskRunFindingSeverity, c as TaskRunFindingStatus } from './TaskRunFindingActionType.d-B4VmmbB6.cjs';
 ...
 * `never` checks.
 */
interface UiBridgeRequestEnvelope {
  /**
 ...
 */
interface UiBridgeResponseEnvelope {
  /**
...
export type { AppEvent, CanvasPanel as CanvasUpdatePanel, DevSeedFindingPayload, RecommendationReviewDecisionPayload, RunnerConnectedConnection, RunnerFinding, RunnerFindingCodeContext, RunnerFindingUserInput, RunnerRelayMessage, RunnerStatusEvent, TerminalExitEvent, TerminalInfo, TerminalOutputEvent, UiBridgeRequestEnvelope, UiBridgeResponseEnvelope };
