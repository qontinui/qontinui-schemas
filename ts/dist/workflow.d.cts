 ...
 * rules.
 */
interface ModelOverrideConfig$2 {
  /**
   ...
   */
  routing_rules?: RoutingRule$2[] | null;
  /**
...
interface WorkflowStage$1 {
   ...
   */
  condition?: StageCondition$1 | null;
  /**
   ...
   */
  model_overrides?: {
    [k: string]: ModelOverrideConfig$1;
  };
  /**
   ...
   */
  retry_policy?: RetryPolicy$1 | null;
  /**
 ...
 * rules.
 */
interface ModelOverrideConfig$1 {
  /**
   * Fallback model if the primary fails with a retryable error.
   */
  fallback_model?: string | null;
   ...
   * wins; unmatched falls back to this config's static fields.
   */
  routing_rules?: RoutingRule$1[] | null;
  /**
   * Temperature override for this phase (`0.0`–`1.0`).
   */
  temperature?: number | null;
 ...
 */
type WorkflowArchitecture$1 = "traditional" | "agentic_verification" | "multi_agent_pipeline";
...
interface UnifiedWorkflow {
   ...
   */
  workflow_architecture?: WorkflowArchitecture$1 | null;
  [k: string]: unknown;
}
/**
 * Configuration for a single health check URL.
 ...
 */
type PlaywrightExecutionMode$1 = "independent" | "chained";
/**
 * Execution mode for a [`CommandStep`].
 */
type CommandMode$1 = "shell" | "check" | "check_group" | "test";
/**
 * Test-runner kinds surfaced by `CommandStep` when `mode = "test"`.
 */
type TestType$1 = "playwright" | "qontinui_vision" | "python" | "repository" | "custom_command";
/**
 ...
 */
type VerificationCategoryKind$4 =
  | "existence"
  | "uniqueness"
...
interface CommandStep$1 {
   ...
   */
  execution_mode?: PlaywrightExecutionMode$1 | null;
  /**
   ...
   */
  verification_category?: VerificationCategoryKind$4 | null;
  /**
 ...
 * module because it is only referenced from [`BaseStepFields`].
 */
type VerificationCategoryKind$3 =
  | "existence"
  | "uniqueness"
  | "referential_integrity"
  | "semantic_correctness"
...
interface PromptStep$1 {
   ...
   * Verification depth category.
   */
  verification_category?: VerificationCategoryKind$3 | null;
  [k: string]: unknown;
}
/**
 * Per-step retry configuration carried by [`BaseStepFields::retry`].
 ...
 * module because it is only referenced from [`BaseStepFields`].
 */
type VerificationCategoryKind$2 =
  | "existence"
  | "uniqueness"
  | "referential_integrity"
  | "semantic_correctness"
...
interface UiBridgeStep$1 {
   ...
   * Verification depth category.
   */
  verification_category?: VerificationCategoryKind$2 | null;
  [k: string]: unknown;
}
/**
 * Per-step retry configuration carried by [`BaseStepFields::retry`].
 ...
 * module because it is only referenced from [`BaseStepFields`].
 */
type VerificationCategoryKind$1 =
  | "existence"
  | "uniqueness"
  | "referential_integrity"
  | "semantic_correctness"
...
interface WorkflowStep$1 {
   ...
   * Verification depth category.
   */
  verification_category?: VerificationCategoryKind$1 | null;
  /**
...
type ModelOverrides = {
    setup?: ModelOverrideConfig$2;
    agentic?: ModelOverrideConfig$2;
    completion?: ModelOverrideConfig$2;
    verification?: ModelOverrideConfig$2;
    investigation?: ModelOverrideConfig$2;
    summary?: ModelOverrideConfig$2;
    generation?: ModelOverrideConfig$2;
};
...
type SetupStep = CommandStep$1 | PromptStep$1 | UiBridgeStep$1 | WorkflowStep$1;
type VerificationStep = CommandStep$1 | PromptStep$1 | UiBridgeStep$1 | WorkflowStep$1;
type AgenticStep = PromptStep$1;
type CompletionStep = CommandStep$1 | PromptStep$1 | UiBridgeStep$1 | WorkflowStep$1;
...
export { type ActionPlan, type ActionPlanExecuteRequest, type ActionPlanResult, type AgenticStep, type ApiAssertion, type ApiContentType, type ApiVariableExtraction, type BaseStep, type CheckType, type CommandMode, type CommandStep$1 as CommandStep, type CompletionStep, type CompositionTemplate, type CostAnnotations, type CostCategory, type CoverageMatrix, DEFAULT_SUMMARY_PROMPT, type DependencyEdge, type DependencyGraph, type DependencyNode, type ElementTarget, type HealthCheckUrl$1 as HealthCheckUrl, type HttpMethod, type LogSourceSelection, type ModelOverrideConfig$2 as ModelOverrideConfig, type ModelOverrides, type MultiStepTemplate, PHASE_INFO, type PlannedAction, type PlannedActionResult, type PlannedActionType, type PlaywrightExecutionMode, type PromptStep$1 as PromptStep, type QualityFinding, type QualityFindingCategory, type QualityFindingSeverity, type QualityReport, type RetryPolicy$2 as RetryPolicy, type RoutingRule$3 as RoutingRule, STEP_TYPES, type SetupStep, type SingleStepTemplate, type SkillAuthor, type SkillCategory, type SkillDefinition, type SkillExport, type SkillExportManifest, type SkillImportResult, type SkillOrigin, type SkillParameter, type SkillParameterOption, type SkillRef, type SkillTemplate, type StageCondition$2 as StageCondition, type StageInput$2 as StageInput, type StageOutput$2 as StageOutput, type StepCost, type StepTypeInfo, type StepTypeName, type TestType, type UiBridgeAction, type UiBridgeStep$1 as UiBridgeStep, type UnifiedStep, type UnifiedWorkflow, type VerificationCategory, type VerificationCategoryKind, type VerificationStep, type WorkflowArchitecture, type WorkflowExport, type WorkflowExportManifest, type WorkflowFeatures, type WorkflowImportResult, type WorkflowPhase, type WorkflowStage$1 as WorkflowStage, type WorkflowStep$1 as WorkflowStep };
