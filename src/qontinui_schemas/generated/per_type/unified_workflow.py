...
#   timestamp: 2026-04-17T10:49:07+00:00
...
class UnifiedWorkflow(BaseModel):
    ...
    auto_include_contexts: Annotated[
        bool | None,
        Field(
    ...
    constraint_overrides: Annotated[
        dict[str, bool] | None,
        Field(
    ...
    enforce_token_budget: Annotated[
        bool | None,
        Field(
    ...
    htn_state_machine_path: Annotated[
        str | None,
        Field(
    ...
    log_source_selection: Annotated[
    ...
    max_sweep_iterations: Annotated[
        int | None,
    ...
    workflow_architecture: Annotated[
