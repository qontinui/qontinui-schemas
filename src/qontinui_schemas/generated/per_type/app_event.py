...
#   timestamp: 2026-04-14T18:01:35+00:00
...
class Data17(BaseModel):
    details: Any | None = None
    iteration: conint(ge=0) | None = None
    status: str
    task_run_id: str
    timestamp: int
...
class Data23(BaseModel):
    accumulated_length: conint(ge=0)
    chunk: str
    task_run_id: str
...
class Data24(BaseModel):
    failed_step_count: conint(ge=0)
    is_stalled: bool
    iteration: conint(ge=0)
    new_failures: conint(ge=0)
    passed_step_count: conint(ge=0)
    repeated_failures: conint(ge=0)
    skipped_step_count: conint(ge=0)
    task_run_id: str
...
class Data25(BaseModel):
    attributed_failures: conint(ge=0)
    blame_json: str
    iteration: conint(ge=0)
    oscillating_files: conint(ge=0)
    revert_patterns: conint(ge=0)
    task_run_id: str
