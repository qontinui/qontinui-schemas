...
#   timestamp: 2026-04-26T16:01:56+00:00
...
class UpdateScheduledTaskRequest(BaseModel):
    ...
    catchUpGraceSeconds: Annotated[
        int | None,
        Field(description='Update the catch-up grace window (seconds).', ge=0),
    ] = None
    catchUpPolicy: Annotated[
        CatchUpPolicy | None, Field(description='Update the catch-up policy.')
    ] = None
    ...
    launchFailureBackoffSeconds: Annotated[
        int | None,
        Field(description='Update the launch-failure backoff base (seconds).', ge=0),
    ] = None
