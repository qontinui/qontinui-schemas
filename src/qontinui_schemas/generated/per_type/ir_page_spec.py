...
#   timestamp: 2026-07-02T06:29:13+00:00
...
class IrApiAssertion1(BaseModel):
    """
...
class IrApiAssertion2(BaseModel):
    """
    API assertion: either a value-level assertion (status_code, json_path, etc.)
    or a schema-conformance assertion (conforms_to — Phase 2 placeholder).
    """
...
class IrApiAssertion3(BaseModel):
    """
    API assertion: either a value-level assertion (status_code, json_path, etc.)
    or a schema-conformance assertion (conforms_to — Phase 2 placeholder).
    """
...
class IrApiAssertion4(BaseModel):
    """
    API assertion: either a value-level assertion (status_code, json_path, etc.)
    or a schema-conformance assertion (conforms_to — Phase 2 placeholder).
    """
...
class IrApiAssertion5(BaseModel):
    """
    API assertion: either a value-level assertion (status_code, json_path, etc.)
    or a schema-conformance assertion (conforms_to — Phase 2 placeholder).
    """
...
class IrApiAssertion6(BaseModel):
    """
    API assertion: either a value-level assertion (status_code, json_path, etc.)
    or a schema-conformance assertion (conforms_to — Phase 2 placeholder).
    """
    ...
    type: Literal['conforms_to']


class IrApiAssertion(
    RootModel[
        IrApiAssertion1
        | IrApiAssertion2
        | IrApiAssertion3
    ...
    root: Annotated[
        ...
        | IrApiAssertion6,
        Field(
            description='API assertion: either a value-level assertion (status_code, json_path, etc.)\nor a schema-conformance assertion (conforms_to — Phase 2 placeholder).',
            discriminator='type',
        ),
    ]


class IrApiRequest(BaseModel):
    body: Any | None = None
