...
#   filename:  CreateScheduledTaskRequest.json
#   timestamp: 2026-04-26T15:57:37+00:00
...
class CreateScheduledTaskRequest(BaseModel):
    ...
    autoFixOnFailure: Annotated[
        bool | None, Field(description='Trigger auto-fix on failure.')
    ] = None
    catchUpGraceSeconds: Annotated[
        int | None,
        Field(
            description='Optional catch-up grace window override (seconds). `None` =\nrunner default (300s).',
            ge=0,
        ),
    ] = None
    catchUpPolicy: Annotated[
        CatchUpPolicy | None,
        Field(
            description='Optional catch-up policy override. `None` = runner default\n([`CatchUpPolicy::RunOnce`]).'
        ),
    ] = None
    ...
    launchFailureBackoffSeconds: Annotated[
        int | None,
        Field(
            description='Optional override for the launch-failure backoff base (seconds).\n`None` = runner default (60s).',
            ge=0,
        ),
    ] = None
    ...
    skipIfCompleted: Annotated[
        bool | None, Field(description='Skip future runs once the task has succeeded.')
    ] = None
    successCriteria: Annotated[
        str | None, Field(description='Free-form success criteria description.')
    ] = None
    task: Annotated[
        ScheduledTaskType,
