...
#   timestamp: 2026-04-14T18:01:50+00:00
...
class CreateScheduledTaskRequest(BaseModel):
    ...
    auto_fix_on_failure: bool | None = Field(
        None, description='Trigger auto-fix on failure.'
    )
    ...
    skip_if_completed: bool | None = Field(
        None, description='Skip future runs once the task has succeeded.'
    )
    success_criteria: str | None = Field(
        None, description='Free-form success criteria description.'
    )
