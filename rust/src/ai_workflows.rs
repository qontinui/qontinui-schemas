...
pub struct ExecutionStep {
    ...
    #[serde(default, rename = "takeScreenshot", skip_serializing_if = "is_false")]
    pub take_screenshot: bool,

    /// Delay in seconds before taking screenshot (default 0).
    #[serde(
        default,
        rename = "screenshotDelay",
    ...
    #[serde(
        default,
        rename = "playwrightScriptContent",
        skip_serializing_if = "Option::is_none"
    )]
